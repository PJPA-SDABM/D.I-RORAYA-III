...
var format_LuasBaku_3 = new ol.format.GeoJSON();
var features_LuasBaku_3 = format_LuasBaku_3.readFeatures(json_LuasBaku_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_LuasBaku_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LuasBaku_3.addFeatures(features_LuasBaku_3);
var lyr_LuasBaku_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LuasBaku_3, 
                style: style_LuasBaku_3,
                popuplayertitle: 'Luas Baku',
                interactive: true,
                title: '<img src="styles/legend/LuasBaku_3.png" /> Luas Baku'
            });
var format_LuasFungsional_4 = new ol.format.GeoJSON();
var features_LuasFungsional_4 = format_LuasFungsional_4.readFeatures(json_LuasFungsional_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_LuasFungsional_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LuasFungsional_4.addFeatures(features_LuasFungsional_4);
var lyr_LuasFungsional_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LuasFungsional_4, 
                style: style_LuasFungsional_4,
                popuplayertitle: 'Luas Fungsional',
                interactive: true,
                title: '<img src="styles/legend/LuasFungsional_4.png" /> Luas Fungsional'
            });
