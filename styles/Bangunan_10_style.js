var size = 0;
var placement = 'point';
function categories_Bangunan_10(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        image: new ol.style.RegularShape({radius: 17.6 + size, points: 6,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 2.28}), fill: new ol.style.Fill({color: 'rgba(217,119,6,1.0)'})}),
...
var style_Bangunan_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("k_aset");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    var style = categories_Bangunan_10(feature, value, size, resolution, labelText,
