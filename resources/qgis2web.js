...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [120.944252, -5.399861, 122.850897, -3.049401],
            units: 'degrees'
        })
    })
});
...
map.getView().fit([122.327503, -4.321187, 122.460080, -4.253861], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">D.I RORAYA III</h2>';
        return titleElement;
    })(),
